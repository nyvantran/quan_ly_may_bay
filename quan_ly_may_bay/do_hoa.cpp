...
void DHThemMB(DSMayBay ds_may_bay, int* x,int* y)
{
	...
	char nhap;
	char shmb[15]{}, lmb[40]{}, soday[2]{}, sodong[2]{}; shmb[0] = '\0'; 
	lmb[0] = '\0'; soday[0] = '\0'; sodong[0] = '\0';
	int i0 = 0, i1 = 0, i2 = 0, i3 = 0;
	setbkcolor(1);
		
	while (1) {
		if (((int)(nhap = getch()) != 0) && ((int)nhap != 0) && (mouseThemMb(*x, *y) == 0)) {
